...
class Imposto_de_Renda(Calculador_de_Imposto, ABC):
    ...
    def calcular_imposto(self, salario_mensal, qtd_dependentes):
        faixa_imposto = self._adaptador_imposto.get_faixas_de_imposto(salario_mensal)
        aliquota, parcela_dedutivel = faixa_imposto[['aliquota', 'parcela_dedutivel']].values[0]
        self._imposto_total = \
            (salario_mensal * aliquota / 100) - parcela_dedutivel - (qtd_dependentes * 189.59)
